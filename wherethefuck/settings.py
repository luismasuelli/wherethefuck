"""
Django settings for wherethefuck project.
...
SECRET_KEY = '4wluj2i0#@i4_z=lqu$%e49**1g4w%j@bx6%z-3ju6re@h&b(7'
...
ROOT_URLCONF = 'wherethefuck.urls'
...
WSGI_APPLICATION = 'wherethefuck.wsgi.application'
